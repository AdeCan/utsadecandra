...
class ItemInstaxdetails extends StatelessWidget {
  const ItemInstaxdetails({Key? key}) : super(key: key);
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            ...
            Center(
              child: Image.asset(
                'images/fujifilmbanner.png',
                width: 100,
                height: 20,
              ),
            ),
            Image.asset(
              'images/titiktiga.png',
              width: 70,
              height: 35,
            ),
          ],
