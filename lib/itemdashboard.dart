  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Image.asset('images/fujifilmbanner.png',
          width: 100.0,
          height: 20.0,
        ),
          actions: [
              ...
              subtitle: Column(
                ...
                children: [
                  ...
                  TextButton(
                    ...
                    onPressed: () {
                      Navigator.pushNamed(context, '/itemdetailsintax');
                    },
                    child: Text(
                      'Buy',
                      style: TextStyle(
